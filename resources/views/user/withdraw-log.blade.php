...
</div><div class="fake-class"><span class="data-details-title">Payment Gateway</span><span class="data-details-info">{{isset($data->method->name) ? $data->method->name : 'N/A'}}</span></div></div><div class="gaps-3x"></div><h6 class="card-sub-title">Transaction Info</h6><ul class="data-details-list"><li><div class="data-details-head">Transaction Type</div><div class="data-details-des"><strong>Withdrawal</strong></div></li><!-- li --
...
<!-- li --><li><div class="data-details-head">Transaction ID</div><div class="data-details-des"><span>{{$data->transaction_id}}</span> <span></span></div></li><!-- li --><li><div class="data-details-head">Amount Expected</div><div class="data-details-des">{!! $basic->currency !!} {{$data->amount}}</div></li>
<li><div class="data-details-head">{{isset($data->method->name) ? $data->method->name : 'N/A'}} Details</div><div class="data-details-des">{{$data->send_details}}</div></li>

@if($data->wallet_id > 0)
<li><div class="data-details-head">{{isset($data->method->name) ? $data->method->name : 'N/A'}} Type</div><div class="data-details-des">{{\App\Currency::whereId($data->currency_id)->first()->name }}</div></li>
@endif

<li><div class="data-details-head">Withdrawal Charge</div><div class="data-details-des">{!! $basic->currency !!} {{$data->charge}}</div></li>

<li><div class="data-details-head">Amount Debited</div><div class="data-details-des">{!! $basic->currency !!} {{$data->amount + $data->charge}}</div></li>
