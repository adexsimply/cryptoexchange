        ...
        <table class="data-table dt-init user-list">
          <thead>
            <tr class="data-item data-head">
              ...
              <th class="data-col dt-token">Total TRX</th>
              <th class="data-col dt-verify">Verification Status</th>
          ...
          <tbody>
            ...
            <tr class="data-item">
              <td class="data-col dt-user"><span class="lead user-name">{{$user->fname}} {{$user->lname}}</span><span class="sub user-id">{{$user->username}}</span></td>
              <td class="data-col dt-email"><span class="sub sub-s2 sub-email">{{$user->email}}</span></td>
              <td class="data-col dt-token"><span class="lead lead-btoken">{{$basic->currency_sym}}{{number_format(App\Transaction::whereUser_id($user->id)->where('status', 'Confirmed')->sum('amount'), $basic->decimal)}}</span></td>
              ...
              <td class="data-col dt-login"><span class="sub sub-s2 sub-time">{{$user->created_at}}</span></td>
                ...
                <div class="relative d-inline-block"><a href="#" class="btn btn-light-alt btn-xs btn-icon toggle-tigger"><em class="ti ti-more-alt"></em></a>
                  <div class="toggle-class dropdown-content dropdown-content-top-left">
                    <ul class="dropdown-list">
                      <li><a href="{{route('user.single', $user->id)}}"><em class="ti ti-eye"></em> View Details</a></li>

                      @if($user->status < 1) <li><a href="{{route('user.activate', $user->id)}}"><em class="ti ti-check"></em> Activate</a></li>
